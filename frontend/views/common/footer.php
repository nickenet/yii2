<div class="footer">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                <h4>Follow us</h4>
                <a href="#"><img src="/yii2/frontend/web/images/facebook.png"  alt="facebook"></a>
                <a href="#"><img src="/yii2/frontend/web/images/twitter.png"  alt="twitter"></a>
                <a href="#"><img src="/yii2/frontend/web/images/linkedin.png"  alt="linkedin"></a>
                <a href="#"><img src="/yii2/frontend/web/images/instagram.png"  alt="instagram"></a>
            </div>
